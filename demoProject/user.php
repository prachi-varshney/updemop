...
<body>
                            ...
                            <div class="p-3 shadow mt-2" style="border:1px solid lightgray">
                                <form id="search">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <input type="text" name="phone" class="form-control form-control-sm numeric"
    ...
    <div class="pagination">
        <ul>
            <li><a href="#" onclick="loadTable('list', 'asc', 'id', 5, 0)">First</a></li>
            <li><a href="#" onclick="loadTable('list', 'asc', 'id', 5, 0)">Previous</a></li>
            <li id="pagination-links"></li>
            <li><a href="#" onclick="loadTable('list', 'asc', 'id', 5, 0)">Next</a></li>
            <li><a href="#" onclick="loadTable('list', 'asc', 'id', 5, 0)">Last</a></li>
        </ul>
    </div>
</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label">Phone No <span class="req-star"
                                                    style="color: red;">*</span></label>
                                            <input type="text" class="form-control form-control-sm numeric" name="phone"
